...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Create fixed-width host Tn5 counting bins centered on protein-coding "
            "and tRNA gene TSS positions."
        )
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=250,
        help="Flank size around the TSS in bp (default: 250)",
    )
...
def main() -> None:
    ...
    protein_coding = collect_gene_tss(
        args.host_gtf,
        host_contigs,
